...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'governerate_id'); ?>
		<?php echo $form->dropDownList($model, 'governerate_id', GxHtml::listDataEx(Governorate::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
