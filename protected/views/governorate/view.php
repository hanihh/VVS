...
<h2><?php echo GxHtml::encode($model->getRelationLabel('districts')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->districts as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('district/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
