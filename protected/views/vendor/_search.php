...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'status_id', GxHtml::listDataEx(VendorStatus::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'type_id'); ?>
		<?php echo $form->dropDownList($model, 'type_id', GxHtml::listDataEx(VendorType::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
