...
<div class="container" id="page">
	...
	<div id="header">
		<div id="logo"><img style="height: 135px" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo.gif"></img><?php //echo CHtml::encode(Yii::app()->name); ?></div>
	</div><!-- header -->
    <!--
	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Distributions', 'url'=>array('/distribution'),'itemOptions'=>array('class'=>'icon_chart')),
				array('label'=>'Beneficiaries', 'url'=>array('/Beneficiary')),
				array('label'=>'Vendors', 'url'=>array('/Vendor')),				
				array('label'=>'Vouchers', 'url'=>array('/Voucher')),
			),
		)); ?>
	</div> <!--mainmenu -->
